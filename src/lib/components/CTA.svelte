...
<div class="mx-4">
    <div
        use:animateIn
        class="group/card relative md:mx-auto my-16 flex w-full md:max-w-7xl flex-col space-y-12 rounded-xl bg-gray-50 p-6 md:p-16 opacity-0"
    >
        <div
        ...
        <div class="flex flex-col space-y-4 z-20 ">
            <h2 class="text-4xl md:text-6xl font-semibold tracking-tighter text-gray-800">
        ...
        <div class="flex space-x-8 z-20">
            <a href="/contact" class="flex w-fit items-center group/button gap-2 rounded-full hover:bg-orange-200 bg-orange-100 transition-all duration-100 p-4 pl-8">
            ...
            <a href="/gallery" class="flex items-center gap-2 group/explore rounded-md ml-8 bg-none">
                <p class="text-md md:text-lg font-medium tracking-tighter">Explore</p>
                <div
                    class="flex cursor-pointer items-center duration-100 group-hover/explore:ml-2 justify-center rounded-md p-2 text-black"
                >
                    <ChevronIcon className="size-5 stroke-2" />
                </div>
            </a>
        </div>
    </div>
