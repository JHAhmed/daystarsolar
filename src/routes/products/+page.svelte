<script>
	...
	import { animateIn, solarImage1, solarImage2, solarImage3, solarImage4 } from '$lib';
	...
	<div class="mb-10 text-left md:mb-12 lg:mb-16">
		...
		<div class="my-12 max-w-3xl text-lg text-gray-600">
			<p class="mb-4">
				...
				across South India. As authorized partners for <strong>Panasonic Solar</strong>, we ensure
				you get Tier-1 panels with 25-year warranties.
			</p>
			<p>
